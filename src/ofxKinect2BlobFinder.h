...
class ofxKinect2BlobFinder {
    public:
      ofxKinect2BlobFinder();
      void init(ofxMultiKinectV2 *newKinect, bool standarized);
      bool isInited();
    ...
    protected:
        ...
        ofxMultiKinectV2 * kinectPtr;
    
        ofVec3f kinect2CameraToWorld(float x, float y, float z );
